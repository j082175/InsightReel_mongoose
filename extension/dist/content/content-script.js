...
var MinimalUtils = /*#__PURE__*/function () {
  ...
  return _createClass(MinimalUtils, null, [{
    ...
    value: function log(level, message) {
      ...
      switch (level) {
        case 'info':
          console.log("".concat(prefix, " \u2139\uFE0F ").concat(message), data || '');
          break;
        case 'warn':
          console.warn("".concat(prefix, " \u26A0\uFE0F ").concat(message), data || '');
          break;
        case 'error':
...
var MinimalApiClient = /*#__PURE__*/function () {
  function MinimalApiClient() {
    var serverUrl = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : environment.SERVER_URL;
  ...
  return _createClass(MinimalApiClient, [{
    key: "checkConnection",
    value: function () {
      var _checkConnection = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var response, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            ...
            case 2:
              _context.p = 2;
              _t = _context.v;
              MinimalUtils.log('error', 'Server connection failed', _t);
...
var MinimalContentScript = /*#__PURE__*/function () {
  ...
  return _createClass(MinimalContentScript, [{
    ...
    value: function init() {
      ...
      if (!this.platform) {
        MinimalUtils.log('warn', '지원되지 않는 플랫폼', window.location.hostname);
        return;
      }
    ...
    value: function () {
      var _checkServerConnection = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var isConnected, _t2;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 2:
              _context2.p = 2;
              _t2 = _context2.v;
              MinimalUtils.log('error', '서버 연결 확인 중 오류', _t2);
            case 3:
    ...
    key: "handleMessage",
    value: function () {
      var _handleMessage = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(request, sender, sendResponse) {
        var _t3, _t4;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              _context3.p = 0;
              _t3 = request.action;
              _context3.n = _t3 === 'ping' ? 1 : _t3 === 'getStatus' ? 2 : 3;
              break;
            case 1:
              sendResponse({
                success: true,
            ...
            case 5:
              _context3.p = 5;
              _t4 = _context3.v;
              MinimalUtils.log('error', '메시지 처리 실패', _t4.message);
              sendResponse({
                error: _t4.message
              });
            case 6:
    ...
    value: function validateEnvironment() {
      ...
      if (!environment.GOOGLE_API_KEY) {
        MinimalUtils.log('warn', 'GOOGLE_API_KEY 환경변수가 설정되지 않았습니다.');
      }
    }
  }]);
}(); // Content Script 실행
