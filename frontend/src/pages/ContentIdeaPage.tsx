  ...
  const mockIdeas: ContentIdea[] = [
    {
      ...
      description:
        'ChatGPT API를 활용해서 반복적인 업무를 자동화하는 실용적인 방법들을 소개합니다.',
      category: '기술/IT',
      platform: 'YouTube',
      difficulty: 'Medium',
      ...
      status: 'new',
      script:
        '안녕하세요! 오늘은 ChatGPT를 활용해서 업무를 자동화하는 방법에 대해 알아보겠습니다...',
    },
    {
      id: 2,
      title: '홈카페 달인이 되는 원두 고르기 꿀팁',
      description:
        '집에서도 카페처럼 맛있는 커피를 만들 수 있는 원두 선택부터 추출까지의 모든 과정',
      category: '라이프스타일',
      platform: 'Instagram',
      difficulty: 'Easy',
    ...
    },
    {
      ...
      description:
        '바쁜 일상 속에서도 할 수 있는 간단하지만 효과적인 아침 요가 루틴을 제안합니다.',
      category: '건강/피트니스',
      platform: 'TikTok',
      difficulty: 'Easy',
    ...
    },
    {
      ...
      description:
        '주식 투자를 처음 시작하는 사람들을 위한 기초 개념부터 실전 투자 방법까지',
      category: '재테크',
      platform: 'YouTube',
      difficulty: 'Hard',
      tags: ['주식', '투자', '재테크', '초보자'],
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                <span
                  className={`px-2 py-1 text-xs rounded-full ${
                    selectedIdea.platform === 'YouTube'
                      ? 'bg-red-100 text-red-700'
                      : selectedIdea.platform === 'TikTok'
                ...
                <span
                  className={`px-2 py-1 text-xs rounded-full ${getDifficultyColor(selectedIdea.difficulty)}`}
                >
                  {selectedIdea.difficulty === 'Easy'
                    ? '쉬움'
                    : selectedIdea.difficulty === 'Medium'
                      ? '보통'
                      : '어려움'}
                </span>
                <span
                  className={`px-2 py-1 text-xs rounded-full ${getStatusColor(selectedIdea.status)}`}
                >
    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          AI를 활용하여 창의적인 콘텐츠 아이디어를 생성하고 관리하세요
        </p>
      </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span
                      className={`px-2 py-1 text-xs rounded-full ${getDifficultyColor(idea.difficulty)}`}
                    >
                    ...
                    <span
                      className={`px-2 py-1 text-xs rounded-full ${getStatusColor(idea.status)}`}
                    >
