              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
                  <p className="text-2xl font-bold text-indigo-600">
                    {analysisResults.reduce(
                      (sum, result) => sum + result.videoCount,
                      0
                    )}
                  </p>
                ...
                <div className="text-center">
                  <p className="text-2xl font-bold text-green-600">
                    {formatViews(
                      analysisResults.reduce(
                        (sum, result) => sum + result.totalViews,
                        0
                      )
                    )}
                  </p>
                ...
                <div className="text-center">
                  <p className="text-2xl font-bold text-purple-600">
                    {formatViews(
                      Math.round(
                        analysisResults.reduce(
                          (sum, result) => sum + result.avgViews,
                          0
                ...
                <div className="text-center">
                  <p className="text-2xl font-bold text-orange-600">
                    {Math.round(
                      (analysisResults.reduce(
                        (sum, result) => sum + result.trends.engagementRate,
                        0
                      ) /
                        analysisResults.length) *
                        10
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                      ...
                      <div>
                        <p className="text-sm text-gray-600">총 조회수</p>
                        <p className="text-xl font-semibold text-gray-900">
                          {formatViews(result.totalViews)}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">평균 조회수</p>
                        <p className="text-xl font-semibold text-gray-900">
                          {formatViews(result.avgViews)}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">업로드 빈도</p>
                        <p className="text-xl font-semibold text-gray-900">
                          {result.trends.uploadFrequency}
                        </p>
                      </div>
                    </div>
