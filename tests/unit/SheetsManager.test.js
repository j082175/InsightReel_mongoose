...
describe('SheetsManager', () => {
    ...
    describe('testConnection', () => {
        ...
        it('스프레드시트가 없으면 생성해야 함', async () => {
            ...
            sheetsManager.createSpreadsheet = jest
                .fn()
    ...
    describe('createSpreadsheet', () => {
        ...
        it('새로운 스프레드시트를 생성해야 함', async () => {
            ...
            sheetsManager.getFirstSheetName = jest
                .fn()
                .mockResolvedValue('Sheet1');
    ...
    describe('saveVideoData', () => {
        ...
        it('필수 필드가 없으면 에러를 발생시켜야 함', async () => {
            ...
            await expect(
                sheetsManager.saveVideoData(invalidVideoData),
            ).rejects.toThrow();
        });
        ...
        it('API 호출 실패 시 에러를 발생시켜야 함', async () => {
            ...
            await expect(
                sheetsManager.saveVideoData(videoData),
            ).rejects.toThrow('데이터 저장 실패');
        });
    });
