...
class VideoDataConverter {
  ...
  static convertToYouTubeSchema(videoData, rowNumber = 1) {
    ...
    const result = {
      ...
      keywords: Array.isArray(analysis.keywords) ? analysis.keywords : (analysis.keywords ? [analysis.keywords] : []),
      hashtags: Array.isArray(analysis.hashtags) ? analysis.hashtags : (analysis.hashtags ? [analysis.hashtags] : []),
      mentions: Array.isArray(analysis.mentions) ? analysis.mentions : (analysis.mentions ? [analysis.mentions] : []),
