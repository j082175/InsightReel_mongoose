    ...
    static convertToLegacyFormat(hybridData, videoId) {
        try {
            ...
            const converted = {
                ...
                channel:
                    hybridData.channelName ||
                    hybridData.channelTitle ||
                    '채널 없음',
                channelId: hybridData.channelId || '',

                // 날짜 처리
                publishedAt:
                    hybridData.publishedAt ||
                    hybridData.uploadDate ||
                ...
                categoryId:
                    hybridData.youtubeCategoryId ||
                    hybridData.categoryId ||
                    '0',
                ...
                commentsCount: String(
                    hybridData.commentCount || hybridData.commentsCount || '0',
                ),

                // 채널 정보 (하이브리드 데이터에서 매핑)
                subscribers: String(
                    hybridData.subscribers || hybridData.subscriberCount || '0',
                ),
                channelVideos: String(
                    hybridData.channelVideos ||
                        hybridData.channelVideoCount ||
                        '0',
                ),
                channelViews: String(
                    hybridData.channelViews ||
                        hybridData.channelViewCount ||
                        '0',
                ),
                ...
                // 해시태그 및 멘션 (설명에서 추출)
                hashtags: YouTubeDataProcessor.extractHashtags(
                    hybridData.description || '',
                ),
                mentions: YouTubeDataProcessor.extractMentions(
                    hybridData.description || '',
                ),
                ...
                youtubeHandle:
                    hybridData.youtubeHandle ||
                    hybridData.channelCustomUrl ||
                    '',
                channelUrl:
                    hybridData.channelUrl ||
                    `https://www.youtube.com/channel/${
                        hybridData.channelId || ''
                    }`,
