...
exports.HybridDataConverter = void 0;
const logger_1 = require("../utils/logger");
// 임시로 require 사용 (YouTubeDataProcessor는 아직 JS 파일)
// 컴파일 후 dist에서 실행되므로 경로 조정
const youtube_data_processor_1 = __importDefault(require("../utils/youtube-data-processor"));
/**
...
class HybridDataConverter {
    ...
    static convertToLegacyFormat(hybridData, videoId) {
        try {
            ...
            const converted = {
                ...
                // 썸네일 처리
                thumbnailUrl: youtube_data_processor_1.default.buildThumbnailUrl(videoId),
                // 카테고리 처리
                ...
                durationFormatted: youtube_data_processor_1.default.formatDuration(hybridData.duration || 0),
                ...
                channelVideos: String(hybridData.channelVideos || hybridData.channelVideoCount || "0"),
                ...
                // 해시태그 및 멘션 (설명에서 추출)
                hashtags: youtube_data_processor_1.default.extractHashtags(hybridData.description || ""),
                mentions: youtube_data_processor_1.default.extractMentions(hybridData.description || ""),
                ...
                channelUrl: hybridData.channelUrl ||
                    `https://www.youtube.com/channel/${hybridData.channelId || ""}`,
                // 하이브리드 메타데이터
                extractionMethod: "hybrid",
                dataSources: hybridData.dataSources && hybridData.dataSources.primary
                    ? hybridData.dataSources
                    : { primary: "unknown" },
                // 추가 정보
            ...
            logger_1.ServerLogger.info("🔄 하이브리드 → 레거시 포맷 변환 완료", {
            ...
            logger_1.ServerLogger.error("하이브리드 데이터 변환 실패:", errorMessage);
            // 최소한의 기본 데이터 반환
            return {
                videoId: videoId,
    ...
    static convertCategory(data) {
        ...
        if (data.youtubeCategoryId) {
            return youtube_data_processor_1.default.getCategoryName(data.youtubeCategoryId);
        }
...
exports.HybridDataConverter = HybridDataConverter;
exports.default = HybridDataConverter;
//# sourceMappingURL=HybridDataConverter.js.map